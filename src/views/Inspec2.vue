        ...
        <table style="width:100%;border:1px solid grey;border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="border:1px solid grey;">
              ...
              <subject subject="Rolls"></subject>/<txt :txt="r.TOTAL_QTY"></txt>
              <subject subject="KGs"></subject>
            </td>
        ...
        <table style="width:100%;border:1px solid grey;border-collapse: collapse;">
          <tr>
            ...
            <td style="border:1px solid grey;width:25px;">
              ...
              <subject subject="of Defect"></subject>
            </td>
            <td style="border:1px solid grey;width:25px;">
              <subject subject="No."></subject><br />
            ...
            <td style="border:1px solid grey;width:25px;">
              <subject subject="Gross"></subject><br />
              <subject subject="yds"></subject>
            </td>
            <td style="border:1px solid grey;width:25px;">
              <subject subject="Net"></subject><br />
              <subject subject="yds"></subject>
            </td>
            <td style="border:1px solid grey;width:25px;">
              <subject subject="Actual"></subject><br />
              <subject subject="Grade"></subject>
            </td>
            <td style="border:1px solid grey;width:45px;">
          ...
          <template v-for="d in r.lines[n-1]">
            ...
            <tr>
              ...
              <td class="cell">
                <txt :txt="d.DEF_POINT_01"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_02"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_03"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_04"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_05"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_06"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_07"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_08"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_09"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_10"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_11"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_12"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_13"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_14"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_15"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_16"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_17"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_18"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_19"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_20"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_21"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_22"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_23"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_24"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_25"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_26"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_27"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_28"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_29"></txt>
              </td>
              <td class="cell">
                <txt :txt="d.DEF_POINT_30"></txt>
              </td>
              <td style="border:1px solid grey;">
                <subject subject=""></subject>
              </td>
